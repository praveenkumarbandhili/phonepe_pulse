...
icon = Image.open(r"C:\phonepe\png-icon.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By B PRAVEEN KUMAR",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *B PRAVEEN KUMAR*!
...
# Repo.clone_from("https://github.com/PhonePe/pulse.git", "C:\phonepe\phonepe_e")
...
if selected == "Home":
    ...
    with col2:
        st.image("C:\phonepe\download home.jpg")
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv('C:\phonepe\Statenames.csv')
            df1.State = df2
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/praveenkumarbandhili/phonepe_pulse.git")
    ...
    with col2:
        ...
        st.write(" ")
        st.write(" ")
        st.image("C:\phonepe\download pulseimage.jpg")
